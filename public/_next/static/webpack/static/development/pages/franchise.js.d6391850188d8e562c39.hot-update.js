  ...
  return __jsx("div", {
    ...
    onSubmit: function onSubmit(e) {
      ...
      fetch("http://onen.co.kr/contacts", {
        method: "POST",
        body: bodyJson // body data type must match "Content-Type" header
