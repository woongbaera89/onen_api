  ...
  return __jsx("div", {
    ...
    onSubmit: function onSubmit(e) {
      ...
      fetch("http://onen.co.kr/contacts", {
        method: "POST",
        body: _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(bodyJson) // body data type must match "Content-Type" header
